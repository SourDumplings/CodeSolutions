...
use image::{ImageBuffer, Luma, DynamicImage, ImageError};
...
fn write_image(filename: &str, pixels: &[u8], bounds: (usize, usize))
    -> Result<(), ImageError>
{
    let buffer = ImageBuffer::<Luma<u8>, Vec<u8>>::from_raw(bounds.0 as u32, bounds.1 as u32, pixels.to_vec())
...
/* 
.\mandelbrot.exe mandel.png 1000x750 -1.20,0.35 -1,0.20
*/
fn main()
{
