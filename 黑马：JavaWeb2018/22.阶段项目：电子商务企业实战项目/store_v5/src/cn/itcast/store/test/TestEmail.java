	...
	public static void main(String[] args) throws Exception {
		...
		Authenticator authenticator = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				return new PasswordAuthentication("aaa@czmail.com", "aaa");
			}
		};
		...
		message.setFrom(new InternetAddress("aaa@czmail.com"));
		// 2.2 收件人 , to:收件人 ， cc ：抄送，bcc：暗送（密送）。（模拟账号）
		message.setRecipient(RecipientType.TO, new InternetAddress("bbb@czmail.com"));
		// 2.3 主题
